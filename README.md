...
An implementation of [VINS-Mask](https://ieeexplore.ieee.org/document/9351597) based on [VINS-Mono](https://github.com/HKUST-Aerial-Robotics/VINS-Mono)

## Run VINS-Mask on VIODE dataset

```
    roslaunch vins_estimator viode.launch 
    rosbag play YOUR_PATH_TO_DATASET/parking_lot/3_high.bag 
```
If you want to run other sequence of [VIODE dataset](https://zenodo.org/record/4493401), please modify `dynamic_RGB` parameter in config/viode/viode_config.yaml file. Refer to the [VIODE](https://github.com/kminoda/VIODE) files to change the RGB value of dynamic vehicles of corresponding sequence.

Below is the primary README of [VINS-Mono](https://github.com/HKUST-Aerial-Robotics/VINS-Mono).
